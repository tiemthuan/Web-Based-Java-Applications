...
public class EditController extends HttpServlet {
    ...
    private static final String ERROR="vewCart.jsp";
    private static final String SUCCESS="vewCart.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (cart!= null) {
                TeaDTO tea =tea= cart.getCart().get(id);
